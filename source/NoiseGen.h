...
public:
    ...
    void landMapImage(shared_ptr<Image> land, shared_ptr<Image> mountain, shared_ptr<Image> landMap, Point2int32 range, float oceanLevel, float power, float multiplier);
};